...
- `/auth/callback.html` - Supabase callback handler
- `/dashboard/index.html` - Protected user dashboard
...
const SUPABASE_REDIRECT_URL = 'https://your-domain.com/auth/callback.html';
const SUPABASE_RESET_REDIRECT = 'https://your-domain.com/reset-password.html';
```
...
3. In **Auth Settings**:
   ...
   - Update confirmation URL to: `https://your-domain.com/auth/callback.html`
   - Update password reset URL to: `https://your-domain.com/reset-password.html`
...
3. If email confirmation enabled:
   ...
   - User clicks link → `/auth/callback.html`
...
### Password Reset Flow
3. User requests reset at `/forgot-password.html`
2. Email sent with reset link containing token
3. User clicks link → `/reset-password.html?access_token=...`
4. User sets new password
5. Auto redirect to dashboard

### Protected Routes
- `/dashboard/index.html` requires authentication
