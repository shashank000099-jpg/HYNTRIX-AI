...
const stats = [
  { label: 'Credits Left', value: mockUser.credits, sub: 'Available this month', color: 'text-blue-400' },
  { label: 'XP Points', value: mockUser.xp.toLocaleString(), sub: 'Experience earned', color: 'text-purple-400' },
  { label: 'Level', value: mockUser.level, sub: 'Founder rank', color: 'text-green-400' },
  { label: 'Plan', value: mockUser.plan.toUpperCase(), sub: 'Current plan', color: 'text-orange-400' }
];
