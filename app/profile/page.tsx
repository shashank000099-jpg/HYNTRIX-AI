...
import { User, Mail, Award, Zap, Shield, Save } from 'lucide-react'
...
export default function ProfilePage() {
  ...
  const statCards = [
    { label: 'Level', value: user?.level || 1, icon: Award, color: 'text-green-400', bg: 'bg-green-500/10' },
    { label: 'XP', value: user?.xp || 0, icon: Zap, color: 'text-purple-400', bg: 'bg-purple-500/10' },
    { label: 'Plan', value: (user?.plan || 'Free').toUpperCase(), icon: Shield, color: 'text-blue-400', bg: 'bg-blue-500/10' },
    { label: 'Credits', value: user?.credits || 0, icon: User, color: 'text-orange-400', bg: 'bg-orange-500/10' },
  ]
