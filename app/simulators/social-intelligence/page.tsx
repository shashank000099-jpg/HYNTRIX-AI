  ...
  return (
    <div className="space-y-8">
      <div className="space-y-3">
        ...
        <p className="max-w-3xl text-sm leading-7 text-slate-300">Analyze profiles across Instagram, YouTube, X, LinkedIn and Telegram for engagement, trust and monetization.</p>
      </div>
